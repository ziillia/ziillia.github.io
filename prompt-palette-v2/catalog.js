...
(function(root){
  ...
  const C={
    ...
    compositions:[
      row('follow','変化量に従う','Follow variation','構図は選択した変化量に従う。','Let the selected variation level determine composition.'),
      row('reference','参照固定','Reference','写真内の人物サイズ、配置、縦横の収まり、クロップ、背景との面積比、ネガティブスペースを参照画像に合わせる。誌面上の写真枠を変えても、写真内部の構図は変えない。','Match the reference subject scale, placement, portrait-or-landscape fit, crop, subject-to-background ratio and negative space within each photograph. Changes to page frames must not alter the composition inside the photograph.'),
      row('cohesive','自然な差分','Cohesive','同じ撮影セッションとして自然につながる構図差を作る。人物サイズ、画面内の配置、クロップ、背景の見せ方、ネガティブスペースを控えめに変え、同じ切り抜きの反復を避けながら統一感を保つ。姿勢、撮影角度、光はこの指定だけを理由に変更しない。','Create modest compositional differences that remain connected as one photographic session. Gently vary subject scale, placement, crop, background visibility and negative space, avoiding repeated crops while retaining cohesion. This choice alone must not change posture, camera angle or light.'),
      row('distinct','明確な差分','Distinct','各写真を明確に異なる構図として成立させる。人物サイズ、画面内の配置、クロップ、背景との面積比、前景と奥行き、ネガティブスペースの使い方を写真ごとに変え、同じトリミングや人物配置を繰り返さない。指定された写真数と人物数は増やさない。','Make every photograph a clearly distinct composition. Vary subject scale, placement, crop, subject-to-background ratio, foreground depth and use of negative space between photographs. Do not repeat the same framing or subject placement, and do not increase the specified photograph or subject count.'),
      row('ai-distinct','AIで差別化','AI distinct','具体的な構図は指定せず、各写真に適した構図を生成側が決める。ただし、各写真は参照画像および同じ誌面内の他の写真と明確に異なる構図にし、同じトリミング、人物サイズ、人物配置を繰り返さない。','Do not prescribe an exact composition; let the generator determine a suitable composition for each image. Every photograph must nevertheless use a composition clearly distinct from the reference and the other photographs in the layout, without repeating the same crop, subject scale or placement.'),
      row('omit','未記入','Omit','構図の専用指示を出力しない。','Emit no dedicated composition instruction.')
    ],
    scenes:[
    ...
    cameraModes:[
      ...
      row('free-distinct','AIに任せる','AI decides','撮影距離、角度、光の具体値は指定せず、生成側に任せる。','Leave exact camera distance, angle and lighting choices to the generator.'),
    ...
    bodies:[row('full-bust','バストのボリューム','Bust volume','成人女性モデルのバストのボリュームを増やす。身長感、骨格、胸郭は維持する。','Increase bust volume in the adult female model, retaining perceived height, skeletal proportions and rib cage.')],
    outfits:[
      row('bold','ミニマル','Minimal','ハイエンドなファッションエディトリアルとして成立する、軽快で大胆なミニマルスタイリング。衣装は、細いストラップ、細幅の縁取り、必要最小限の直線と曲線、コンパクトなパネル構成、身体に沿うシャープなカッティングを中心にする。軽やかな素材と少ない構成要素によって、明確で洗練されたシルエットを作る。サイドタイ、アシンメトリー、すっきりしたツーピース、またはミニマルなワンピースとしてまとめる。','Lightweight, bold minimal styling suitable for a high-end fashion editorial. Build the garment around slim straps, narrow edging, a minimal arrangement of clean lines and curves, compact panel construction and sharp body-following cuts. Use lightweight materials and very few design elements to create a clear, refined silhouette. Resolve the outfit as a clean two-piece or minimal one-piece, with details such as side ties or asymmetry.'),
      row('refined','洗練','Refined','ハイエンドなファッションエディトリアルとして成立する、上品で洗練されたスタイリング。鍛えられた身体のラインが自然に伝わるフィット感、端正なシルエット、軽やかで上質な素材、精密で控えめなディテールを組み合わせる。すっきりしたツーピース、ミニマルなワンピース、軽やかなセットアップ、または身体に沿うトップとボトムから、撮影環境に調和する一着を選ぶ。色、素材、シルエットを統一し、落ち着いた編集的な品位を持たせる。','Polished, refined styling suitable for a high-end fashion editorial. Combine a fit that naturally presents the trained silhouette with clean proportions, lightweight premium materials and precise, restrained details. Choose one outfit suited to the setting: a clean two-piece, a minimal one-piece, a lightweight coordinated set, or fitted separates. Unify its color, material and silhouette with a composed editorial finish.'),
      row('random','おまかせ','Editorial mix','撮影環境に調和する衣装を、モダンカジュアル、リゾートスタイル、ミニマルファッション、端正なセットアップから1着選ぶ。人物を主役にする明確なシルエットと、写真集全体に馴染む色、素材、ディテールを具体化する。','Choose one outfit suited to the setting from modern casualwear, resort styling, minimal fashion or a clean coordinated set. Define a clear subject-centered silhouette with color, material and details that suit the photobook as a whole.'),
      row('athletic','スポーツ','Athletic','撮影環境と動作に合う、機能的で洗練されたスポーツスタイリング。身体の動きを妨げないフィット、軽量で伸縮性のある素材、端正なライン、競技やトレーニングの文脈に適したトップとボトムを1着として構成する。','Functional, refined athletic styling suited to the setting and action. Build one outfit from a movement-ready fit, lightweight stretch materials, clean lines and a top-and-bottom combination appropriate to sport or training.')
    ],
    coverages:[
