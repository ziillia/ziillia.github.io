...
(function(root){
  ...
  const C={
    ...
    outfits:[
      row('bold','ミニマル','Minimal','ロケーションに合わせた、ハイエンドなファッションエディトリアル向けの軽快で構築的なミニマルスタイリング。装飾を抑え、細いストラップ、すっきりしたネックライン、身体に沿うカッティング、サイドタイやアシンメトリーなどの端正なディテールを使う。水辺ではコンパクトなツーピースやミニマルなワンピース、室内・都市では軽やかなトップとボトムやセットアップを選ぶ。色、素材、ストラップ、カッティングにカットごとの変化を持たせ、厚手の競技用ウェアや同じスポーツウェア形状の反復に偏らない。','Light, structured minimal styling for a high-end fashion editorial, adapted to the location. Keep ornament restrained and use slim straps, clean necklines, body-following cuts, side ties or asymmetric details. For waterside settings, choose compact two-piece looks or minimal one-piece designs; for interiors and urban settings, choose lightweight separates or coordinated sets. Vary color, material, straps and cutting between photographs rather than repeating heavy competition wear or the same sportswear silhouette.'),
      row('refined','洗練','Refined','ロケーションに合わせた、ハイエンドなファッションエディトリアルとして成立する上品で洗練されたスタイリング。鍛えられた身体のラインが自然に伝わる適度なフィット感と、端正なシルエット、軽やかで上質な素材、控えめなディテールを組み合わせる。すっきりしたツーピース、ミニマルなワンピース、軽やかなセットアップ、身体に沿うトップとボトムを環境に応じて選ぶ。大胆すぎるカッティングや過剰な装飾、厚手の競技用ウェアの反復を避け、色、素材、シルエットには適度な変化を持たせながら、全カットで統一感のある編集的な品位を保つ。','Refined, polished styling that reads as a high-end fashion editorial and adapts to the location. Combine a measured fit that naturally shows the trained silhouette with clean proportions, lightweight premium materials and restrained details. Select clean two-piece looks, minimal one-piece designs, lightweight coordinated sets, or fitted separates as appropriate to the setting. Avoid overly bold cutting, excessive ornament and repeated heavy competition wear; vary color, material and silhouette moderately while maintaining cohesive editorial polish across the photographs.'),
