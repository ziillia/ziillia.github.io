(function(){
  ...
  document.addEventListener('click',async event=>{
    ...
    else if(action==='export')download('prompt-palette-v25.json',JSON.stringify({format:'prompt-palette',state,collapsed:fold},null,2));
